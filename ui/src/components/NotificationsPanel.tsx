...
const ICON_MAP: Record<Notification['type'], { icon: string; color: string; bg: string }> = {
    like: { icon: 'favorite', color: 'text-red-500', bg: 'bg-red-50 dark:bg-red-900/30' },
    comment: { icon: 'chat_bubble', color: 'text-blue-500', bg: 'bg-blue-50 dark:bg-blue-900/30' },
    follow: { icon: 'person_add', color: 'text-green-500', bg: 'bg-green-50 dark:bg-green-900/30' },
    tip: { icon: 'payments', color: 'text-orange-500', bg: 'bg-orange-50 dark:bg-orange-900/30' },
    message: { icon: 'mail', color: 'text-purple-500', bg: 'bg-purple-50 dark:bg-purple-900/30' },
};
            ...
            <div className="flex-1 overflow-y-auto hide-scrollbar">
                {notifications.length === 0 ? (
                    <div className="flex flex-col items-center justify-center h-[50vh] text-gray-400 dark:text-gray-500">
                        <span className="material-symbols-rounded text-5xl mb-3 text-gray-200 dark:text-gray-700">notifications_off</span>
                        ...
                        return (
                            ...
                            >
                                <div className="relative shrink-0">
                                    ...
                                    />
                                    <div className={`absolute -bottom-0.5 -right-0.5 w-5 h-5 rounded-full ${iconInfo.bg} ${iconInfo.color} flex items-center justify-center border-2 border-white dark:border-gray-900`}>
