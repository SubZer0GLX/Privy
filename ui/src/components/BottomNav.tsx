...
export const BottomNav: React.FC<BottomNavProps> = ({ currentTab, onTabChange, onCreatePost }) => {
    return (
        <nav className="h-16 bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border-t border-gray-200 dark:border-gray-700 px-6 flex items-center justify-between z-50 shrink-0">
            <button
